...
let findShortest = (data) => {
  return data.reduce((shortestSoFar, currentCharacter) => {
    // Number function turns string into number                   // ternary
    return Number(shortestSoFar.height) < Number(currentCharacter.height) ? shortestSoFar : currentCharacter;
    // chaining; return the name of the character that is shortest
  }).name;
};
