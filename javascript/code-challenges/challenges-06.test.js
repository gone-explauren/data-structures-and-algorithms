...
const getNames = (arr) => {
  // split makes the string into an array, reverse reverses the array, join makes the array into a string again, and map creates a new string so the original string remains unmodified
  return arr.map(peep => peep.name.split('').reverse().join(''));
};
